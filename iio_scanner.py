...
def check_board_other(ctx):
    if check_config(ctx,[ device('ad7291-ccbox'), device('ad9361-phy'), device('cf-ad9361-lpc',4) ]):
        return 'packrf'
    if check_config(ctx,[ device('ad9517'), device('ad9361-phy'), device('cf-ad9361-lpc',4) ]):
        return 'adrv9361'
    if check_config(ctx,[ device('ad9517'), device('ad9361-phy'), device('cf-ad9361-lpc',2) ]):
        return 'adrv9364'
    if check_config(ctx,[ device('adm1177'), device('ad9361-phy'), device('cf-ad9361-lpc',2) ]):
        return 'pluto'
